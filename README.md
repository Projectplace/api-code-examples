...
👉 **[Authentication Overview (AUTH_README.md)](../auth/AUTH_README.md)** - Choose the right auth method for your needs

### Quick Links to Authentication Examples:
- **[OAuth2 Authorization Code Flow](../auth/py-oauth2-authorization-code/)** ⭐ Recommended for user access
- **[OAuth2 Client Credentials Flow](../auth/py-oauth2-client-credentials/)** ⭐ Recommended for service accounts  
- **[OAuth1 (Legacy)](../auth/py-oauth1/)** - For maintaining existing integrations
